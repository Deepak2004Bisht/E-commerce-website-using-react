                ...
                <article>
                  ...
                  <div className="cart-collaterals">
                    <div className="cart_totals">
                      ...
                      <div className="proceed-to-checkout" onClick={() => setMenu("checkout")}>
                        <Link to="/checkout"><a href="checkout.html" className="checkout-button btn btn--lg btn--primary full-width">
                          Proceed to checkout
                          </a>
                        </Link>
                      </div>
